	...
	if ($_POST['action'] == 'add') {
		...
		if ($email != '' && $message != '') {
			if (preg_match($pattern, $email)) {
				...
				echo 'error|<div class="alert alert-danger"><button type="button" class="close" data-dismiss="alert">×</button>Please enter a valid email address.</div>';
			}
		} else {
			echo 'error|<div class="alert alert-danger"><button type="button" class="close" data-dismiss="alert">×</button>Please fill all the required fields.</div>';
		}
	}
